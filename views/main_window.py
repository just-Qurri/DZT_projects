        ...
        if device_type and params:
            if device_type in DeviceConstants.DEFAULTS_BY_DEVICE:
                ...
                display_mapping = {
                    ...
                    "RET_TOR300_670_HV": "RET-670/ТОР-300 (ОПОРА ВН)",
                    "RET_TOR300_670_LV": "RET-670/ТОР-300 (ОПОРА НН)",
...
© 2026 Все права защищены."""
    ...
    def _create_device_section(self, parent):
        ...
        device_options = [
            ...
            "RET-521 (ОПОРА ВН)",
            "RET-521 (ОПОРА НН)",
            "RET-670/ТОР-300 (ОПОРА ВН)",
            "RET-670/ТОР-300 (ОПОРА НН)",
            "SPAC810-T (ОПОРА ВН)",
            "SPAC810-T (ОПОРА НН)"
        ]
    ...
    def _on_device_change(self, event=None):
        ...
        try:
            ...
            device_mapping = {
                ...
                "RET-670/ТОР-300 (ОПОРА ВН)": "RET_TOR300_670_HV",
                "RET-670/ТОР-300 (ОПОРА НН)": "RET_TOR300_670_LV",
