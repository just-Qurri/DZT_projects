        ...
        if device_type and params:
            if device_type in DeviceConstants.DEFAULTS_BY_DEVICE:
                ...
                display_mapping = {
                    ...
                    "RET_TOR300_670_HV": "RET-670/ТОР-300/RED-670 (ДЗЛ) (ОПОРА ВН)",
                    "RET_TOR300_670_LV": "RET-670/ТОР-300/RED-670 (ДЗЛ) (ОПОРА НН)",
...
1. ВЫБОР УСТРОЙСТВА
   ...
   - Для RET-521, RET-670, SPAC810-T и ТОР-300 доступны варианты выбора опорных сторон (ВН или НН)
...
- Для RET-670, SPAC810-T, ТОР-300 наклоны вводятся в процентах
...
трансформаторов и линии на базе RED-670.

Поддерживаемые устройства:
• МР-801 (микропроцессорная защита)
• RET-521 (терминал ABB)
• RET-670 (терминал ABB)
• RED-670 (терминал ABB) - ДЗЛ
• SPAC810-T (терминал ABB)
• ТОР-300 (терминал РЕЛЕМАТИКА)
...
© 2026 Все права защищены."""
    ...
    def _create_device_section(self, parent):
        ...
        device_options = [
            ...
            "RET-521 (ОПОРА ВН)",
            "RET-521 (ОПОРА НН)",
            "RET-670/ТОР-300/RED-670 (ДЗЛ) (ОПОРА ВН)",
            "RET-670/ТОР-300/RED-670 (ДЗЛ) (ОПОРА НН)",
            "SPAC810-T (ОПОРА ВН)",
            "SPAC810-T (ОПОРА НН)"
        ]
    ...
    def _on_device_change(self, event=None):
        ...
        try:
            ...
            device_mapping = {
                ...
                "RET-670/ТОР-300/RED-670 (ДЗЛ) (ОПОРА ВН)": "RET670_TOR300_HV",
                "RET-670/ТОР-300/RED-670 (ДЗЛ) (ОПОРА НН)": "RET670_TOR300_LV",
                "SPAC810-T (ОПОРА ВН)": "SPAC810T_HV",
                "SPAC810-T (ОПОРА НН)": "SPAC810T_LV"
            }
